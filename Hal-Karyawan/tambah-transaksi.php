   ...
   <aside class="main-sidebar sidebar-light-warning elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="../dist/img/avatar3.png" alt="User Image" width="100px">
        </div>
        <div class="info">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-info">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form class="form-horizontal" method="post" action="go-tambah-detail.php"> 
                <input type="hidden" class="form-control" name="nota" value="<?php echo $nota; ?>">
              <div class="card-body">
              <div class="form-group row">
                  ...
                  <select class="custom-select" name="paket" id="paket">
						...
						?>
							<option value="<?php echo $pl['harga'];?>"><?php echo $pl['nama_paket'];?></option>
						<?php
							}
						?>
                ...
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">Keterangan Paket</label>
                  <div class="col-sm-10">
                    <textarea id="ket" name="ket" class="form-control" rows="3" placeholder="Masukan Keterangan Pesanan anda"></textarea>
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">Berat</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="berat" id="berat" placeholder="Masukan Berat Pesanan anda">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">Total</label>
                  <div class="col-sm-10">
                    <input type="text" readonly class="form-control" name="total" id="total" placeholder="Total Biaya Paket per berat">
                  </div>
                </div>
              </div>
              <!-- /.card-body -->
...
?>
              <tr>
                ...
                <td>
                    <a href="go-hapus-transaksi.php?no=<?php echo $tl['no_detail_pemesanan'];?>&nota=<?php echo $tl['kd_pemesanan'];?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Pesanan Ini ??')"> <i class="fas fa-trash"></i>
                </td>
              </tr>
<?php
...
?>
        ...
        <!-- form start -->
      <form class="form-horizontal" method="post" action="go-transaksi-selesai.php"> 
          <input type="hidden" class="form-control" name="nota" value="<?php echo $nota; ?>">
            <div class="card-body">
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">Nota</label>
                  <div class="col-sm-10">
                    <input type="text" readonly class="form-control" name="nota" id="nota" value="<?php echo $nota; ?>">
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <select class="custom-select" name="pelanggan" id="pelanggan">
						<?php
							include 'koneksi.php';
							$user_pelanggan = mysqli_query($koneksi,"select * from pelanggan");
							while($up = mysqli_fetch_array($user_pelanggan)){
						?>
							<option value="<?php echo $up['nama_pelanggan'];?>/<?php echo $up['no_hp'];?>"><?php echo $up['nama_pelanggan'];?> / <?php echo $up['no_hp'];?></option>
						<?php
							}
						?>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-3">
                    <select class="custom-select" name="pembayaran" required>
                      <option selected="BELUM LUNAS">Belum Lunas</option>
                      <option selected="SUDAH LUNAS">Sudah Lunas</option>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-3">
                    ...
                    <input type="date" class="form-control pull-right" name="tgl_selesai" id="tgl_selesai">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">Total Bayar</label>
                  <div class="col-sm-10">
                    <input type="text" readonly class="form-control" name="totalbayar" id="totalbayar" value="<?php echo $total; ?>">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">Dibayar</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="dibayar" id="dibayar" placeholder="Masukan Jumlah Biaya yang dibayar">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">Kembalian</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="kembalian" id="kembalian" placeholder="Jumlah Kembalian anda dari pembayaran laundry">
                  </div>
                </div>
              </div>
              <!-- /.card-body -->
