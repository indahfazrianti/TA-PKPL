  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Laporan Transaksi Laundry</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                      <h3 class="card-title">Laporan Transaksi Laundry</h3>
                    </div>
			
			<form class="form-horizontal" method="post" action="view-laporan.php" target="-blank"> 
              <div class="card-body">
              ...
              <div class="card-footer">
                <button type="submit" class="btn btn-primary float-right">Tampil</button>
              </div>
            </form>
