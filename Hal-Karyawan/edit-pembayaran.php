...
?>
            <form class="form-horizontal" method="post" action="go-ubah-pembayaran.php"> 
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-3">
                    <select class="custom-select" name="pembayaran" id="pembayaran">
                      ...
                      <option value="<?php echo $tl['pembayaran'];?>"><?php echo $tl['pembayaran'];?></option>
...
?>
              <tr>
                ...
                <td>
                    <a href="go-hapus-transaksi.php?no=<?php echo $tl['no_detail_pemesanan'];?>&nota=<?php echo $tl['kd_pemesanan'];?>"> <i class="fas fa-trash"></i>
                </td>
              </tr>
<?php
