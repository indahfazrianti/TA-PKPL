...
<?php 
              include 'koneksi.php';
			  $nm = $_GET['nm'];
              $transaksi_laundry = mysqli_query($koneksi,"select * from transaksi_pemesanan where nm_pelanggan = '$nm'");
              ...
              <tr>
                ...
                <td>
					          <?php if($tl['status_pesanan'] == 'BARU'){ ?>
						          <a href="" class="btn btn-warning"><?php echo $tl['status_pesanan']; ?></a>
					          <?php }elseif($tl['status_pesanan'] == 'PROSES CUCI'){ ?>
						          <a href="" class="btn btn-info"><?php echo $tl['status_pesanan']; ?></a>
                    <?php }elseif($tl['status_pesanan'] == 'PROSES SETRIKA'){ ?>
                      <a href="" class="btn btn-info"><?php echo $tl['status_pesanan']; ?></a>
                    <?php }elseif($tl['status_pesanan'] == 'PROSES PACKING'){ ?>
                      <a href="" class="btn btn-info"><?php echo $tl['status_pesanan']; ?></a>
                    <?php }else{ ?>
                      <a href="" class="btn btn-success"><?php echo $tl['status_pesanan']; ?></a>
                    <?php } ?>
				        </td>
				        <td>
                    <?php if($tl['pembayaran'] == 'BELUM LUNAS'){ ?>
						          <a href="" class="btn btn-warning"><?php echo $tl['pembayaran']; ?></a>
					          <?php }elseif($tl['pembayaran'] == 'SUDAH LUNAS'){ ?>
						          <a href="" class="btn btn-info"><?php echo $tl['pembayaran']; ?></a>
                    <?php } ?>
				</td>
