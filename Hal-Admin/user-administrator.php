            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                      ...
                      <button type="submit" class="btn btn-primary float-right">Tambah Admin</button></a>
                    </div>
        <!-- /.card-header -->
        <div class="card-body">
...
<?php 
              include 'koneksi.php';
              $no = 1;
              $user_admin = mysqli_query($koneksi,"select * from admin");
              while($ua = mysqli_fetch_array($user_admin))
              {

?>
              <tr>
                <td><?php echo $no++; ?></td>
                <td><?php echo $ua['nama_admin'];?></td>
                <td><?php echo $ua['jenis_kelamin'];?></td>
                <td><?php echo $ua['no_hp'];?></td>
                <td><?php echo $ua['alamat'];?></td>
                <td>
                    <a href="edit-admin.php?id_admin=<?php echo $ua['id_admin'];?>"> <i class="fas fa-edit"></i>
                    <a href="go-delete-admin.php?id_admin=<?php echo $ua['id_admin'];?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Admin Ini ??')"> <i class="fas fa-trash"></i>
                </td>
              </tr>
<?php
              }
