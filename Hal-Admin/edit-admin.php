...
$user = mysqli_query($koneksi,"SELECT * FROM user where id = '".$id_admin."'");
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-info">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form class="form-horizontal" method="post" action="go-edit-admin.php?id_admin=<?php echo $id_admin;?>"> 
              <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="nama_admin" class="form-control" name="nama_admin" placeholder="<?php echo $nama_admin; ?>">
                  </div>
                </div>
                <div class="form-group row">
