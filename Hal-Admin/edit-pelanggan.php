...
$pelanggan = mysqli_query($koneksi,"SELECT * FROM pelanggan where id_pelanggan = '".$id_pelanggan."'");
...
$user = mysqli_query($koneksi,"SELECT * FROM user where id = '".$id_pelanggan."'");
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="user-pelanggan.php">User Pelanggan</a></li>
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-info">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form class="form-horizontal" method="post" action="go-edit-pelanggan.php?id_pelanggan=<?php echo $id_pelanggan;?>"> 
              <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="nama_pelanggan" class="form-control" name="nama_pelanggan" placeholder="<?php echo $nama_pelanggan; ?>">
                  </div>
                </div>
                <div class="form-group row">
