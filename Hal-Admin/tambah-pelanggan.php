    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-info">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form class="form-horizontal" method="post" action="./go-tambah-pelanggan.php"> 
              <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="nama_pelanggan" class="form-control" name="nama_pelanggan" placeholder="Masukan Nama Lengkap Anda">
                  </div>
                </div>
                <div class="form-group row">
