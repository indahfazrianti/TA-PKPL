        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="user-karyawan.php" class="nav-link active">
                  <i class="far fa-user nav-icon"></i>
                  <p> User Karyawan  </p>
                </a>
              </li>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">User Karyawan</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                      ...
                      <button type="submit" class="btn btn-primary float-right">Tambah Karyawan</button></a>
                    </div>
        <!-- /.card-header -->
        <div class="card-body">
...
<?php 
              include 'koneksi.php';
              $no = 1;
              $user_karyawan = mysqli_query($koneksi,"select * from karyawan");
              while($uk = mysqli_fetch_array($user_karyawan))
              {

?>
              <tr>
                <td><?php echo $no++; ?></td>
                <td><?php echo $uk['nama_karyawan'];?></td>
                <td><?php echo $uk['jenis_kelamin'];?></td>
                <td><?php echo $uk['no_hp'];?></td>
                <td><?php echo $uk['alamat'];?></td>
                <td>
                    <a href="edit-karyawan.php?id_karyawan=<?php echo $uk['id_karyawan'];?>"> <i class="fas fa-edit"></i>
                    <a href="go-delete-karyawan.php?id_karyawan=<?php echo $uk['id_karyawan'];?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Karyawan Ini ??')"> <i class="fas fa-trash"></i>
                </td>
              </tr>
<?php
              }
