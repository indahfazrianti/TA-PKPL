                ...
                <div class="card">
                    <div class="card-header">
                      ...
                      <a href="tambah-paket.php">
                        <button type="submit" class="btn btn-primary float-right" title="Tambah-Paket">
...
?>
              <tr>
                ...
                <td>
                    <a href="edit-paket.php?nama_paket=<?php echo $pl['nama_paket'];?>"> <i class="fas fa-edit" title="Edit"></i>
                    <a href="go-delete-paket.php?nama_paket=<?php echo $pl['nama_paket'];?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Paket Laundry Ini ??')"> <i class="fas fa-trash" title="Hapus"></i>
                </td>
              </tr>
<?php
              }
