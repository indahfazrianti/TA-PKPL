    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-info">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form class="form-horizontal" method="post" action="./go-tambah-karyawan.php"> 
              <div class="card-body">
                ...
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">Nama Kayrawan</label>
                  <div class="col-sm-10">
                    <input type="nama_karyawan" class="form-control" name="nama_karyawan" placeholder="Masukan Nama Lengkap Anda">
                  </div>
                </div>
                <div class="form-group row">
