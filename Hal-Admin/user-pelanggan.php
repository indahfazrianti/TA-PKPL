        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview  menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="user-pelanggan.php" class="nav-link active">
                  <i class="far fa-user nav-icon"></i>
                  <p> User Pelanggan  </p>
                </a>
              </li>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">User Pelanggan</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                      ...
                      <a href="tambah-pelanggan.php">
                      <button type="submit" class="btn btn-primary float-right">Tambah Pelanggan</button></a>
                    </div>
        <!-- /.card-header -->
        <div class="card-body">
...
?>
              <tr>
                <td><?php echo $no++; ?></td>
                <td><?php echo $up['nama_pelanggan'];?></td>
                <td><?php echo $up['jenis_kelamin'];?></td>
                <td><?php echo $up['no_hp'];?></td>
                <td><?php echo $up['alamat'];?></td>
                <td>
                    <a href="edit-pelanggan.php?id_pelanggan=<?php echo $up['id_pelanggan'];?>"> <i class="fas fa-edit"></i>
                    <a href="go-delete-pelanggan.php?id_pelanggan=<?php echo $up['id_pelanggan'];?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Pelanggan Ini ??')"> <i class="fas fa-trash"></i>
                </td>
              </tr>
<?php
              }
